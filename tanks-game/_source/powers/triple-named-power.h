...
public:
	...
	virtual std::string getIdentifier() const override { return TripleNamedPower::getClassIdentifier(); }
	static std::string getClassIdentifier() { return TripleNamedPower::getClassName(); }
