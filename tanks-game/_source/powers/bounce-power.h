...
public:
	...
	virtual std::string getIdentifier() const override { return BouncePower::getClassIdentifier(); }
	static std::string getClassIdentifier() { return BouncePower::getClassName(); }
