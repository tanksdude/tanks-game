...
public:
	...
	virtual std::string getIdentifier() const override { return SpeedPower::getClassIdentifier(); }
	static std::string getClassIdentifier() { return SpeedPower::getClassName(); }
